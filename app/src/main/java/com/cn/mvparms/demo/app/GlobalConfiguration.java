package com.cn.mvparms.demo.app;
...
import com.cn.mvparms.demo.BuildConfig;
import com.cn.mvparms.demo.mvp.model.api.Api;
import com.cn.mvparms.demo.mvp.model.api.cache.CommonCache;
import com.cn.mvparms.demo.mvp.model.api.service.CommonService;
...
public class GlobalConfiguration implements ConfigModule {
                    ...
                    public Request onHttpRequestBefore(Interceptor.Chain chain, Request request) {
                        /* 如果需要再请求服务器之前做一些操作,则重新返回一个做过操作的的requeat如增加header,不做操作则直接返回request参数
                           return chain.request().newBuilder().header("token", tokenId)
                                  .build(); */
                        Log.e("~~~ request 可在这做处理", request.toString());
                        return request;
                    }
                })
    ...
    public void registerComponents(Context context, IRepositoryManager repositoryManager) {
        repositoryManager.injectRetrofitService(CommonService.class, UserService.class, HomeService.class);
        ...
        lifecycles.add(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityStarted(Activity activity) {
                ...
                if (!activity.getIntent().getBooleanExtra("isInitToolbar", false)) {
                    ...
                    if (activity.findViewById(com.cn.mvparms.demo.R.id.toolbar) != null) {
                        if (activity instanceof AppCompatActivity) {
                            ((AppCompatActivity) activity).setSupportActionBar((Toolbar) activity.findViewById(com.cn.mvparms.demo.R.id.toolbar));
                            ((AppCompatActivity) activity).getSupportActionBar().setDisplayShowTitleEnabled(false);
                        } else {
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                activity.setActionBar((android.widget.Toolbar) activity.findViewById(com.cn.mvparms.demo.R.id.toolbar));
                                activity.getActionBar().setDisplayShowTitleEnabled(false);
                            }
                        }
                    }
                    if (activity.findViewById(com.cn.mvparms.demo.R.id.toolbar_title) != null) {
                        ((TextView) activity.findViewById(com.cn.mvparms.demo.R.id.toolbar_title)).setText(activity.getTitle());
                    }
                    if (activity.findViewById(com.cn.mvparms.demo.R.id.toolbar_back) != null) {
                        activity.findViewById(com.cn.mvparms.demo.R.id.toolbar_back).setOnClickListener(v -> {
